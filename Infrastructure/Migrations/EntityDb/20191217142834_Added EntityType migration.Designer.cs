...
namespace Infrastructure.Migrations.EntityDb
{
    ...
    [Migration("20191217142834_Added EntityType migration")]
    partial class AddedEntityTypemigration
    {
            ...
            modelBuilder.Entity("Core.Models.EntityModel.BaseEntity", b =>
                {
                    ...
                    b.HasIndex("EntityTypeId")
                        .IsUnique()
                        .HasFilter("[EntityTypeId] IS NOT NULL");
            ...
            modelBuilder.Entity("Core.Models.EntityModel.BaseEntity", b =>
                {
                    b.HasOne("Core.Models.EntityModel.EntityType", "EntityType")
                        .WithOne("BaseEntity")
                        .HasForeignKey("Core.Models.EntityModel.BaseEntity", "EntityTypeId");
